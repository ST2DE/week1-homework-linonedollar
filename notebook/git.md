...
```shell=
echo "# week1-homework-linonedollar" >> README.md
# 產生一個README.md檔案，裡面內容會如下圖（一）
```
# ![](https://i.imgur.com/YQwM7xu.png)
```shell=

git init
# 初始化該目錄，讓Git對這個目錄開始進行版本控制
git add README.md
```
:::info
補充：輸入git status 可以觀看到目前檔案內部狀況，因為我是後來才新增兩個文件，所以可以看到git回傳兩個為版控的檔案，可以用git add 檔案名稱 把他們加入版本控制
:::
![](https://i.imgur.com/yQZ44Ty.png)

```shell=
git commit -m "first commit"
git remote add origin https://github.com/ST2DE/week1-homework-linonedollar.git
# 新增遠端版本控制
